...
#
# Created: Sat Dec 27 01:56:44 2014
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.frame_6.setMinimumSize(QtCore.QSize(513, 50))
        self.frame_6.setFrameShape(QtGui.QFrame.StyledPanel)
        self.frame_6.setFrameShadow(QtGui.QFrame.Raised)
        self.frame_6.setObjectName(_fromUtf8("frame_6"))
        self.label_6 = QtGui.QLabel(self.frame_6)
        self.label_6.setGeometry(QtCore.QRect(0, 0, 121, 21))
        font = QtGui.QFont()
        font.setBold(True)
        font.setItalic(False)
        font.setUnderline(False)
        ...
        self.comboBox_strategy = QtGui.QComboBox(self.frame_6)
        self.comboBox_strategy.setGeometry(QtCore.QRect(0, 20, 191, 27))
        self.comboBox_strategy.setObjectName(_fromUtf8("comboBox_strategy"))
        ...
        self.plainTextEdit_strategy = QtGui.QPlainTextEdit(self.frame_7)
        self.plainTextEdit_strategy.setObjectName(_fromUtf8("plainTextEdit_strategy"))
        self.verticalLayout_6.addWidget(self.plainTextEdit_strategy)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.label_6.setText(_translate("MainWindow", "Strategy Select", None))
